...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/colour.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Colour</h1>
    <hr>
    <h1 style="font-size:50px">Renk</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/8bb80c9e-f796-49e6-bd5a-95db014fdf4b/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">What colour is this fish?</p>
    <p class="sentence2">Bu balığın rengi nedir?</p>
  </div>
  <div id="example">
    <p class="sentence1">I don't like the colour of this house.</p>
    <p class="sentence2">Bu evin rengini beğenmedim.</p>
  </div>
</div>
