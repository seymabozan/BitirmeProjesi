...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/really.png");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Really</h1>
    <hr>
    <h1 style="font-size:50px">Gerçekten</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/266282b4-4b01-4415-aca1-1962ba045210/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">"I really do," replied the little black rabbit.</p>
    <p class="sentence2">"Ben gerçekten yaparım, " küçük siyah tavşan cevap verdi.</p>
  </div>
  <div id="example">
    <p class="sentence1">"Really?" "Yes, really."</p>
    <p class="sentence2">"Gerçekten?" "Evet, gerçekten."</p>
  </div>
</div>
