...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/married.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Married</h1>
    <hr>
    <h1 style="font-size:50px">Evli</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/280fa06f-c20a-4f52-999c-9a40ffd268b7/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">They were married in October of 1975.</p>
    <p class="sentence2">1975 Ekiminde evliydiler.</p>
  </div>
  <div id="example">
    <p class="sentence1">We met in 2008. A year later, we got married.</p>
    <p class="sentence2">2008'de tanıştık. Bir yıl sonra evlendik.</p>
  </div>
</div>
