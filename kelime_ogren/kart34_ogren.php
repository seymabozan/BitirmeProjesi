...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/Gain.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Gain</h1>
    <hr>
    <h1 style="font-size:50px">Kazanç</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/b51a035d-12eb-4234-be17-0c554e17d6c2/embed?autoplay=false"> </iframe>
  <hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">The man used much money to gain power.</p>
    <p class="sentence2">Adam güç kazanmak için çok para kullandı.</p>
  </div>
  <div id="example">
    <p class="sentence1">I am not interested in material gain.</p>
    <p class="sentence2">Ben maddi kazançla ilgilenmiyorum.</p>
  </div>
</div>
