...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/dress.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Dress</h1>
    <hr>
    <h1 style="font-size:50px">Elbise</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Lindsey Wixson</cite>
    </blockquote>
    <hr>
    <blockquote class="callout quote">
    The way you dress is an expression of your personality.
    <cite> - Galileo Galilei</cite>
    </blockquotAlessandro Michelee>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/96f2e5ca-9e41-4019-8665-ebdbb18b2501/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">The two girls wore the same dress to the dance.</p>
    <p class="sentence2">İki kız dansta aynı elbiseyi giydi.</p>
  </div>
  <div id="example">
    <p class="sentence1">I wear a floral dress.</p>
    <p class="sentence2">Çiçekli bir elbise giyiyorum.</p>
  </div>
</div>
