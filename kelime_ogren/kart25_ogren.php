...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/souvenirs.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Souvenir</h1>
    <hr>
    <h1 style="font-size:50px">Hatıra</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/1182b036-6aee-4e7d-91bc-b1f129a3a1f0/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">This is a souvenir from Hokkaido.</p>
    <p class="sentence2">Bu, Hokkaido'dan bir hatıra.</p>
  </div>
  <div id="example">
    <p class="sentence1">Is there a souvenir shop in the hotel?</p>
    <p class="sentence2">Otelde bir hediyelik eşya dükkanı var mı?</p>
  </div>
</div>
