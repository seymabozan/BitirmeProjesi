...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/order.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Order</h1>
    <hr>
    <h1 style="font-size:50px">Sipariş</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/c59356fa-9071-48f8-8bac-6bd2a49a126c/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">It's cheaper to order things by the dozen.</p>
    <p class="sentence2">Şeyleri düzine ile sipariş etmek daha ucuzdur.</p>
  </div>
  <div id="example">
    <p class="sentence1">Excuse me, but I didn't order this.</p>
    <p class="sentence2">Affedersiniz fakat ben bunu ısmarlamadım.</p>
  </div>
</div>
