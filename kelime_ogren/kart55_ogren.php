...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/citizen.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Citizen</h1>
    <hr>
    <h1 style="font-size:50px">Vatandaş</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/21bed9fe-dfc7-4c28-ad4a-03c24fdb29e2/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">A good citizen obeys the laws.</p>
    <p class="sentence2">İyi bir vatandaş yasalara uyar.</p>
  </div>
  <div id="example">
    <p class="sentence1">He is a British citizen, but lives in India.</p>
    <p class="sentence2">O bir İngiliz vatandaşı fakat Hindistan'da yaşıyor.</p>
  </div>
</div>
