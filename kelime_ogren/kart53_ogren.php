...
<div class="hero-image">
  <div class="hero-text">
    ...
    <hr>
    <h1 style="font-size:50px">Rezervasyon</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/dddcced8-fb4f-4ec0-a69d-3e2ec1f97bf3/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">The growth of online shopping and booking has greatly improved life for the consumers.</p>
    <p class="sentence2">Online alışveriş ve rezervasyonun büyümesi tüketiciler için hayatı oldukça iyileştirdi.</p>
  </div>
  <div id="example">
    <p class="sentence1">The growth of online shopping and booking has greatly improved life for the customer.</p>
    <p class="sentence2">Çevrimiçi alışveriş ve rezervasyonun büyümesi, müşterinin hayatını büyük ölçüde iyileştirdi.</p>
  </div>
</div>
