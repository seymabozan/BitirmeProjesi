...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/map.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Map</h1>
    <hr>
    <h1 style="font-size:50px">Harita</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Elizabeth Kapu'uwailani Lindsey</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/96ff56ba-9f11-4f43-b416-84881d4ef6a5/embed?autoplay=false"> </iframe>
  <hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">Here's a big map of Germany.</p>
    <p class="sentence2">İşte Almanya'nın büyük bir haritası.</p>
  </div>
  <div id="example">
    <p class="sentence1">A map is available upon request.</p>
    <p class="sentence2">İstek üzerine bir harita mevcuttur..</p>
  </div>
</div>
