...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/shy.jpeg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Shy</h1>
    <hr>
    <h1 style="font-size:50px">Utangaç</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Adriana Lima</cite>
    </blockquote>
    <hr>
    <blockquote class="callout quote">
    I take time to open up with people. But once I know you, I'm fine. I'm a shy person.
    <cite> - Sushant Singh Rajput</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/29106b72-9cbf-41be-a748-2a70cbf6edf9/embed?autoplay=false"> </iframe>
  <hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">She is a very shy girl.</p>
    <p class="sentence2">Çok utangaç bir kız.</p>
  </div>
  <div id="example">
    <p class="sentence1">He was shy at the beginning.</p>
    <p class="sentence2">Başlangıçta utangaçtı.</p>
  </div>
</div>
