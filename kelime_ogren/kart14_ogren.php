...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/bride.png");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Bride</h1>
    <hr>
    <h1 style="font-size:50px">Gelin</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Alice Roosevelt Longworth</cite>
    </blockquote>
    <hr>
    <blockquote class="callout quote">
    Nothing shines out more than a bride in her most natural state.
    <cite> - Masaba Gupta</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/7d04df0a-74ee-4c67-89ca-34631f8d94bb/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">The groom works for a company now, and the bride is our teacher.</p>
    <p class="sentence2">Damat şu anda bir şirket için çalışıyor ve gelin de bizim öğretmenimiz.</p>
  </div>
  <div id="example">
    <p class="sentence1">The bride looked very beautiful.</p>
    <p class="sentence2">Gelin çok güzel görünüyordu.</p>
  </div>
</div>
