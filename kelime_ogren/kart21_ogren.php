...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/accommodation.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Accommodation</h1>
    <hr>
    <h1 style="font-size:50px">Konaklama</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Iain Duncan Smith</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/0b275d7b-c25b-467e-928a-9a2aa7ace043/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">We need accommodation for six.</p>
    <p class="sentence2">Altı kişi için kalacak yere ihtiyacımız var.</p>
  </div>
  <div id="example">
    <p class="sentence1">I am looking for accommodation.</p>
    <p class="sentence2">Yatacak yer arıyorum.</p>
  </div>
</div>
