...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/dolphin.jpg");
  height: 70%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Dolphin</h1>
    <hr>
    <h1 style="font-size:50px">Yunus</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Jacques Yves Cousteau</cite>
    </blockquote>
    <hr>
    <blockquote class="callout quote">
    When I see a dolphin, I know it's just as smart as I am.
    <cite> - Captain Beefheart</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/0bf6422a-d890-4186-ba39-2cde466cbef8/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">The boy considered the dolphin his best friend.</p>
    <p class="sentence2">Çocuk yunusu en iyi arkadaşı olarak düşündü.</p>
  </div>
  <div id="example">
    <p class="sentence1">Thousands of people went to the beach to see the dolphin.</p>
    <p class="sentence2">Binlerce insan yunusu görmek için plaja gitti.</p>
  </div>
</div>
