...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/great.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Great</h1>
    <hr>
    <h1 style="font-size:50px">Harika</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/08838e4a-eb24-472c-a048-3c3b0e592798/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">"How do I look?" "You look great."</p>
    <p class="sentence2">"Nasıl görünüyorum?" "Harika görünüyorsun.".</p>
  </div>
  <div id="example">
    <p class="sentence1">Our relationship is not as great as it used to be.</p>
    <p class="sentence2">İlişkimiz eskisi kadar mükemmel değil.</p>
  </div>
</div>
