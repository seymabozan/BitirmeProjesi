...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/Shark.png");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Shark</h1>
    <hr>
    <h1 style="font-size:50px">Köpek Balığı</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/d00f250b-4f29-48f2-9aed-0783350274c6/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">He was attacked by a shark.</p>
    <p class="sentence2">Bir köpek balığı tarafından saldırıya uğradı.</p>
  </div>
  <div id="example">
    <p class="sentence1">The shark seized him by the leg.</p>
    <p class="sentence2">Köpek balığı onu bacağından yakaladı.</p>
  </div>
</div>
