...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/skirt.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Skirt</h1>
    <hr>
    <h1 style="font-size:50px">Etek</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Shirley Chisholm</cite>
    </blockquote>
    <hr>
    <blockquote class="callout quote">
    Don't let anyone make you believe the length of your skirt is a measure of your character.
    <cite> - Amitabh Bachchan</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/6a6313ea-361a-4af0-ab71-f64911cf5161/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">Those shoes go well with this white skirt.</p>
    <p class="sentence2">Şu ayakkabılar bu beyaz etekle iyi gider.</p>
  </div>
  <div id="example">
    <p class="sentence1">I would like to try the blue striped skirt.</p>
    <p class="sentence2">Ben mavi çizgili eteği denemek istiyorum.</p>
  </div>
</div>
