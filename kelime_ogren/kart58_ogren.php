...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/lets-go.png");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Let’s Go</h1>
    <hr>
    <h1 style="font-size:50px">Gidelim</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Eric Butterworth</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/e326a71c-deba-4956-9ef7-2917c00b1e67/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">Let’s go for a walk, shall we?</p>
    <p class="sentence2">Yürüyüşe çıkalım, olur mu?</p>
  </div>
  <div id="example">
    <p class="sentence1">Let him go to the cinema.</p>
    <p class="sentence2">Bırak sinemaya gitsin.</p>
  </div>
</div>
