...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/bake.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Bake</h1>
    <hr>
    <h1 style="font-size:50px">Fırında Pişirmek</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Jose Marti</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/a88a8322-e483-48b2-96f3-64fd5932f672/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">I took a cooking class last spring and learned to bake bread.</p>
    <p class="sentence2">Ben geçen baharda bir aşçılık dersi aldım ve ekmek pişirmeyi öğrendim.
    </p>
  </div>
  <div id="example">
    <p class="sentence1">Tom can bake really good apple pies.</p>
    <p class="sentence2">GTom gerçekten iyi elmalı turtalar pişirebilir.</p>
  </div>
</div>
