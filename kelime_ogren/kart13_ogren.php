...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Family</h1>
    <hr>
    <h1 style="font-size:50px">Aile</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Michael J. Fox</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/dfe22eb9-c39d-46d6-aa05-2746227f598a/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">Here is a photograph of my family.</p>
    <p class="sentence2">İşte ailemin bir fotoğrafı.</p>
  </div>
  <div id="example">
    <p class="sentence1">One has to protect his family.</p>
    <p class="sentence2">İnsan ailesini korumak zorundadır.</p>
  </div>
</div>
