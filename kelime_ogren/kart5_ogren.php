...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/kitten.png");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Kitten</h1>
    <hr>
    <h1 style="font-size:50px">Yavru Kedi</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/1ba89b9f-2cde-4586-9a3f-e94df4502194/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">The tiger cub looked like a large kitten.</p>
    <p class="sentence2">Kaplan yavrusu büyük bir kedi yavrusu gibi görünüyordu.</p>
  </div>
  <div id="example">
    <p class="sentence1">The kitten wanted in.</p>
    <p class="sentence2">Kedi yavrusu içeri girmek istedi..</p>
  </div>
</div>
