...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/o'clock.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">O’Clock</h1>
    <hr>
    <h1 style="font-size:50px">Saat</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Paul Pierce</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/c7ccddfe-b1df-4de5-a728-660995deddff/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">"What time is it now?" "It's ten o'clock."</p>
    <p class="sentence2">"Şu anda saat kaç?" "Saat on."</p>
  </div>
  <div id="example">
    <p class="sentence1">I waited up for him until ten o'clock.</p>
    <p class="sentence2">10:00'a kadar onu bekledim.</p>
  </div>
</div>
