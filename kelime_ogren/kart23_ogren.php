...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Mosque</h1>
    <hr>
    <h1 style="font-size:50px">Cami</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Rishi Kapoor</cite>
    </blockquote>
    <hr>
    <blockquote class="callout quote">
    Let's close all the Islamist mosques.
    <cite> - Marine Le Pen</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/b308e246-bcf2-48a2-8112-1dfbd6495a88/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">This is a house and that is a mosque.</p>
    <p class="sentence2">Bu bir ev, şu ise camidir.</p>
  </div>
  <div id="example">
    <p class="sentence1">It's the first time I pray in a mosque.</p>
    <p class="sentence2">İlk defa bir camide namaz kılıyorum.</p>
  </div>
</div>
