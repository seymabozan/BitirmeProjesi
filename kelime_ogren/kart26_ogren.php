...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/heart.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Heart</h1>
    <hr>
    <h1 style="font-size:50px">Kalp</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/d8cfacf9-a4bf-4d66-9d55-f0a29e717042/embed?autoplay=false"> </iframe>
  <hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">If you feel like crying, you should cry to your heart's content.</p>
    <p class="sentence2">İçinden ağlamak geliyorsa; gönlünce ağla.</p>
  </div>
  <div id="example">
    <p class="sentence1">You have a good heart.</p>
    <p class="sentence2">İyi bir kalbin var.</p>
  </div>
</div>
