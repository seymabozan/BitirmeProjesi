...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/goodness.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Goodness</h1>
    <hr>
    <h1 style="font-size:50px">İyilik</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/398fe0cb-8700-4564-b3c1-4d494caed427/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">Beauty without goodness is worth nothing</p>
    <p class="sentence2">İyiliği olmayan güzelliğin değeri hiçbir şeydir.</p>
  </div>
  <div id="example">
    <p class="sentence1">For goodness' sake, don't say that!</p>
    <p class="sentence2">Tanrı aşkına, böyle söyleme!</p>
  </div>
</div>
