...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/speedy.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Speedy</h1>
    <hr>
    <h1 style="font-size:50px">Hızlı</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Sameera Reddy</cite>
    </blockquote>
    <hr>
    <blockquote class="callout quote">
    Americans are too speedy.
    <cite> - Mitch McConnell</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/65c8f554-4d3d-41a7-8b46-0659d757cfe7/embed?autoplay=false"> </iframe>
<div class="wrapper">
  <div id="example">
    <p class="sentence1">I was amazed at the speed of the car.</p>
    <p class="sentence2">Arabanın hızına şaşırdım.</p>
  </div>
  <div id="example">
    <p class="sentence1">In towns, speed is limited to 50 km/h.</p>
    <p class="sentence2">Şehirlerde, hız saatte 50 km ile sınırlıdır.</p>
  </div>
</div>
