...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/Wisdom.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Wisdom</h1>
    <hr>
    <h1 style="font-size:50px">Bilgelik</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/ac1cdc6b-a5af-4b4e-b687-29f6b669990d/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">'Philosophy' is a Greek word that means the love of wisdom.</p>
    <p class="sentence2">' Felsefe ' bilgelik sevgisi anlamına gelen Yunanca bir kelimedir.</p>
  </div>
  <div id="example">
    <p class="sentence1">All this worldly wisdom was once the unamiable heresy of some wise man.</p>
    <p class="sentence2">Bütün bu dünyevi bilgelik bir zamanlar herhangi bir bilge adamın sevimsiz sapıklığıydı.</p>
  </div>
</div>
