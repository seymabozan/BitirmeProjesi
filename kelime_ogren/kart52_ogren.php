...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/brand.png");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Brand</h1>
    <hr>
    <h1 style="font-size:50px">Marka</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Alice Temperley</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/3125d098-6b62-456e-8113-31cf5a93ca3e/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">Auldey is a Chinese brand.</p>
    <p class="sentence2">Auldey bir Çin markasıdır.</p>
  </div>
  <div id="example">
    <p class="sentence1">What's your favorite brand of soap?</p>
    <p class="sentence2">Favori sabun markan nedir?</p>
  </div>
</div>
