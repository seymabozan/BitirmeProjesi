...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/lively.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Lively</h1>
    <hr>
    <h1 style="font-size:50px">Neşeli</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Mel Brooks</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/a68a45e6-2139-4a20-9267-257aea6d3b49/embed?autoplay=false"> </iframe>
  <hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">My grandfather is 90 years old and very lively.</p>
    <p class="sentence2">Büyükbabam 90 yaşında ve çok canlı.</p>
  </div>
  <div id="example">
    <p class="sentence1">Today's party was really lively, wasn't it?</p>
    <p class="sentence2">Bugünkü parti gerçekten hareketliydi, değil mi?</p>
  </div>
</div>
