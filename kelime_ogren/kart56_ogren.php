...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/parliament.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Parliament</h1>
    <hr>
    <h1 style="font-size:50px">Meclis</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/66059493-65ef-4ce1-b75d-ba00cba156b6/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">Parliament approved the new law last week.</p>
    <p class="sentence2">Meclis geçen hafta yeni yasayı onayladı.</p>
  </div>
  <div id="example">
    <p class="sentence1">Parliament is now in session.</p>
    <p class="sentence2">Parlamento şimdi oturumdadır.</p>
  </div>
</div>
