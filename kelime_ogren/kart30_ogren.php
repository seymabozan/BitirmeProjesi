...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/Animals.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Animals</h1>
    <hr>
    <h1 style="font-size:50px">Hayvanlar</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/2662594d-7f1c-4388-94d0-d54c6f11841a/embed?autoplay=false"> </iframe>
  <hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">Cows are, for Hindus, sacred animals.</p>
    <p class="sentence2">İnekler Hindular için kutsal hayvanlardır.</p>
  </div>
  <div id="example">
    <p class="sentence1">Human beings differ from other animals in that they can speak and laugh..</p>
    <p class="sentence2">İnsan oğlu konuşabilmeleri ve gülebilmeleri bakımından hayvanlardan farklıdır.</p>
  </div>
</div>
