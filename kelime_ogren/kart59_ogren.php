...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/beautiful.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Beautiful</h1>
    <hr>
    <h1 style="font-size:50px">Güzel</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Jean Anouilh</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/b39fb63c-28cb-4303-82a2-9009488f41a3/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">You have a beautiful name.</p>
    <p class="sentence2">İsminiz çok güzelmiş.</p>
  </div>
  <div id="example">
    <p class="sentence1">Italy is a very beautiful country.</p>
    <p class="sentence2">İtalya çok güzel bir ülke.</p>
  </div>
</div>
