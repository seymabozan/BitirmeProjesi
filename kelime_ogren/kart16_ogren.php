...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/accountant.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Accountant</h1>
    <hr>
    <h1 style="font-size:50px">Muhasebeci</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/8f8895d5-65e9-48ae-80fe-0675d905af8a/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">He is an accountant at the company.</p>
    <p class="sentence2">Şirkette bir muhasebecidir.</p>
  </div>
  <div id="example">
    <p class="sentence1">I need to hire an accountant.</p>
    <p class="sentence2">Bir muhasebeci tutmalıyım.</p>
  </div>
</div>
