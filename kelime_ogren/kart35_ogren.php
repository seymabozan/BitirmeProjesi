...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/little.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Little</h1>
    <hr>
    <h1 style="font-size:50px">Küçük</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/9fc3e1b6-fd0c-4932-81a8-d13c2060e7e9/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">I want to drink a little water.</p>
    <p class="sentence2">Biraz su içmek istiyorum.</p>
  </div>
  <div id="example">
    <p class="sentence1">My mother will buy a little fruit.</p>
    <p class="sentence2">Anne biraz meyve satın alacak.</p>
  </div>
</div>
