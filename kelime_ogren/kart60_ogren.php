...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/sit-down.png");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Sit Down</h1>
    <hr>
    <h1 style="font-size:50px">Oturun</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/c08ee898-070f-4a56-b279-f8f6f16e4bba/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">Come in and sit down.</p>
    <p class="sentence2">İçeri gir ve otur.</p>
  </div>
  <div id="example">
    <p class="sentence1">You can sit down if you want.</p>
    <p class="sentence2">İstiyorsan oturabilirsin.</p>
  </div>
</div>
