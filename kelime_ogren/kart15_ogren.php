...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/parents.png");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Parents</h1>
    <hr>
    <h1 style="font-size:50px">Ebeveyn ‘’Anne ve Baba’’</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/23d969d9-2927-4fb6-a7d0-231e02c59cb1/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">Good parents are the best teachers.</p>
    <p class="sentence2">İyi ebeveynler en iyi öğretmenlerdir.</p>
  </div>
  <div id="example">
    <p class="sentence1">Most parents see their own children as the best in the world.</p>
    <p class="sentence2">Çoğu ebeveyn, kendi çocuklarını, dünyada en iyi olarak görüyor.</p>
  </div>
</div>
