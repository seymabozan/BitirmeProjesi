...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/delicious.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Delicious </h1>
    <hr>
    <h1 style="font-size:50px">Lezzetli</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/bf52ae4f-6b0d-4665-a3c5-a270949cdadf/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">"Natto" smells awful, but tastes delicious.</p>
    <p class="sentence2">" Natto " berbat kokuyor, ama lezzetli.</p>
  </div>
  <div id="example">
    <p class="sentence1">The Italian food was delicious.</p>
    <p class="sentence2">İtalyan yemekleri lezzetliydi.</p>
  </div>
</div>
