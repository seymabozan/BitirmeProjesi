...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/Headache.png");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Headache</h1>
    <hr>
    <h1 style="font-size:50px">Baş Ağrısı</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/e8ecee13-4d87-4c55-aefc-7fdd0f4cd387/embed?autoplay=false"> </iframe>
  <hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">Getting rid of garbage has become a major headache for the authorities.</p>
    <p class="sentence2">Çöpten kurtulmak yetkililer için büyük bir baş belası haline gelmiştir.</p>
  </div>
  <div id="example">
    <p class="sentence1">So annoying... Now I get a headache whenever I use the computer!</p>
    <p class="sentence2">Çok sinir bozucu... Ne zaman bilgisayarı kullansam başıma ağrılar giriyor.</p>
  </div>
</div>
