...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/brown.png");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Brown</h1>
    <hr>
    <h1 style="font-size:50px">Kahverengi</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/9919aaf9-5e28-429b-a96f-8d06b90bf31c/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">The medicine was a brown liquid.</p>
    <p class="sentence2">İlaç kahverengi bir sıvıydı.</p>
  </div>
  <div id="example">
    <p class="sentence1">Do you think that brown hair is very beautiful?</p>
    <p class="sentence2">Şu kahverengi saçın çok güzel olduğunu sanıyor musun?</p>
  </div>
</div>
