...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/Belief.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Belief</h1>
    <hr>
    <h1 style="font-size:50px">İnanç</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - D. Elton Trueblood</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/8d6bc6ff-8a51-4598-ae69-e9fb91ca63e5/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">Belief is the death of intelligence.</p>
    <p class="sentence2">İnanç istihbaratın ölümüdür.</p>
  </div>
  <div id="example">
    <p class="sentence1">My belief is that he will succeed.</p>
    <p class="sentence2">Benim inancım onun başarılı olacağıdır.</p>
  </div>
</div>
