...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/rainbow.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Rainbow</h1>
    <hr>
    <h1 style="font-size:50px">Gökkuşağı</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Paul Cezanne</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/0c2be576-fa03-49c7-b505-103d80d63de4/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">A rainbow is a natural phenomenon.</p>
    <p class="sentence2">Bir gök kuşağı doğal bir olaydır.</p>
  </div>
  <div id="example">
    <p class="sentence1">You can see the colors of the spectrum in a rainbow.</p>
    <p class="sentence2">Bir gök kuşağında spektrum renklerini görebilirsiniz.</p>
  </div>
</div>
