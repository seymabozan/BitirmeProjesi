...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/writer.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Writer</h1>
    <hr>
    <h1 style="font-size:50px">Yazar</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/e6576c58-997c-425f-b666-f8c91d682791/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">He was regarded as the greatest writer of the day.</p>
    <p class="sentence2">Çağının en iyi yazarı olarak görülüyordu.</p>
  </div>
  <div id="example">
    <p class="sentence1">I'm not much of a writer.</p>
    <p class="sentence2">Ben çok iyi bir yazar değilim.</p>
  </div>
</div>
