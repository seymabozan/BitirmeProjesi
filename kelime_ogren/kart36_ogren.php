...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/myself.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Myself</h1>
    <hr>
    <h1 style="font-size:50px">Kendim</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/1eca126e-d5d0-4b2e-9481-6a0bf060b42d/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">"I don't like repeating myself." "What?"</p>
    <p class="sentence2">"Kendimi tekrar etmeyi sevmem." "Ne dedin?"</p>
  </div>
  <div id="example">
    <p class="sentence1">I managed to make myself understood in English.</p>
    <p class="sentence2">İngilizce olarak derdimi anlatabildim.</p>
  </div>
</div>
