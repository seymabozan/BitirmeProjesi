...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/cathedral.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Cathedral</h1>
    <hr>
    <h1 style="font-size:50px">Katedral</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/d2cf122b-53a1-4c7f-97bd-188dbc1f5ff2/embed?autoplay=false"> </iframe>
  <hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">This magnificent cathedral dates back to the Middle Ages.</p>
    <p class="sentence2">Bu muhteşem katedral orta çağlara kadar dayanır.</p>
  </div>
  <div id="example">
    <p class="sentence1">The cathedral dominates the cityscape.</p>
    <p class="sentence2">Katedral şehir manzarasına hakimdir.</p>
  </div>
</div>
