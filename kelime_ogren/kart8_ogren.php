...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/salt.jpg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Salt</h1>
    <hr>
    <h1 style="font-size:50px">Tuz</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/9bdb3c52-d5a5-4fba-b8dc-599c77dc1f86/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">"Pass me the salt, please." "Here you are."</p>
    <p class="sentence2">"Bana tuzu uzat, lütfen." "Buyrun."</p>
  </div>
  <div id="example">
    <p class="sentence1">Why is eating too much salt bad for you?</p>
    <p class="sentence2">Çok fazla tuz yemek sizin için niçin kötüdür?</p>
  </div>
</div>
