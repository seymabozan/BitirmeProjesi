...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/Cycling.jpeg");
  height: 60%;
...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Cycling</h1>
    <hr>
    <h1 style="font-size:50px">Bisiklet Sürme</h1>
    <p></p>
  </div>
</div>
...
<section class="component">
    ...
    <cite> - Bradley Wiggins</cite>
    </blockquote>
</section>
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/a9fc504a-6be6-4e87-82a5-b65850e1f7e2/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">That young man is very keen on cycling.</p>
    <p class="sentence2">Şu genç adam bisiklete binmeye çok düşkün.</p>
  </div>
  <div id="example">
    <p class="sentence1">Cycling is a lot of fun.</p>
    <p class="sentence2">Bisiklete binmek çok eğlencelidir.</p>
  </div>
</div>
