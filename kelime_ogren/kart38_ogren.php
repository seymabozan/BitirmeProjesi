...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Tree</h1>
    <hr>
    <h1 style="font-size:50px">Ağaç</h1>
    <p></p>
  </div>
</div>
...
<hr id="ayrac">
<iframe style="width: 100%; border: none; display: block; max-width: 768px; height: 560px;" src="https://getyarn.io/yarn-story/7d074fd2-7b7d-40da-8bc7-5e6e43ac369a/embed?autoplay=false"> </iframe>
<hr id="ayrac">
<div class="wrapper">
  <div id="example">
    <p class="sentence1">The couple carved their initials in an oak tree.</p>
    <p class="sentence2">Çift baş harflerini meşe ağacına kazıdı.</p>
  </div>
  <div id="example">
    <p class="sentence1">The tree grew very tall.</p>
    <p class="sentence2">Ağaç çok uzadı.</p>
  </div>
</div>
